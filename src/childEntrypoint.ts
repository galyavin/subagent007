...
export function configuredChildEntrypointPath(): string {
...
export async function assertConfiguredChildEntrypointAvailable(): Promise<string> {
  const childEntrypoint = configuredChildEntrypointPath();
  try {
