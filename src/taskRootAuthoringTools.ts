...
function guardTaskRootTool(
  ...
  return {
    ...
    async execute(toolCallId, params: PathToolParams, signal, onUpdate, context) {
      const checkedPath = await assertTaskRootAuthoringPath(taskRoot, params.path, tool, snapshotSkillFilePath);
      ...
      return definition.execute(toolCallId, { ...params, path: checkedPath }, signal, onUpdate, context);
    },
  };
}
...
export function createTaskRootAuthoringTools(
  ...
  return [
    guardTaskRootTool(createReadToolDefinition(taskRoot), taskRoot, "read", snapshotSkillFilePath),
    guardTaskRootTool(createGrepToolDefinition(taskRoot), taskRoot, "grep", snapshotSkillFilePath),
    guardTaskRootTool(createFindToolDefinition(taskRoot), taskRoot, "find", snapshotSkillFilePath),
    guardTaskRootTool(createLsToolDefinition(taskRoot), taskRoot, "ls", snapshotSkillFilePath),
    guardTaskRootTool(createWriteToolDefinition(taskRoot), taskRoot, "write", snapshotSkillFilePath),
    guardTaskRootTool(createEditToolDefinition(taskRoot), taskRoot, "edit", snapshotSkillFilePath),
  ];
}
