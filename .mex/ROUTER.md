...
- Observed `full-current` coverage also includes missing-final-output classification, named-session `require_existing` missing-session preflight for both session tools, and local active-child capacity exhaustion/release.
