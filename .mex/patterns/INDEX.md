...
Use plain Markdown links only for pattern files that actually exist.
For a single-task pattern, add: pattern-file.md | one-line trigger.
For a multi-section pattern, add one row per task anchor.
-->
